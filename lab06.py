...
def has_prefix(s, prefix):
    ...
    if prefix == empty:
      return True
    elif s == empty and prefix != empty:
      return False
    elif first(prefix) != first(s):
      return False
    else:
...
def has_sublist(s, sublist):
    ...
    if sublist == empty:
      return True
    elif sublist != empty and s == empty:
      return False
...
def has_kitty_gene(dna):
    ...
    for base in "CATCAT":
      if dna == empty:
        ...
        return has_kitty_gene(rest(dna))
      else:
        dna = rest(dna)
    return True
...
def count_change(amount, denominations):
    ...
    if amount == 0:
        ...
        return count_change(amount - first(denominations), denominations) + count_change(amount, rest(denominations))
